...
Этот компонент кастомизирует ячейку таблицы. С его помощью можно поменять размер текста, выравнивание, добавить в ячейку иконку из [библиотеки иконок](https://uikit.consta.design/?path=/story/components-icons--playground) или что-то ещё.
